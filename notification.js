...
angular.module('notifications', []).
        provider('$notification', function () {
            ...
            function Notification($timeout, s) {
                ...
                return {
                    ...
                    removeNotify: function (notification) {
                        /**
                         * Remove notification
                         * Remove notification from notification queue and reset notification
                         */
                    ...
                    makeNotification: function (type, image, icon, title, content, userData) {
                        ...
                        if (settings.html5Mode) {
                            ...
                            $timeout(function removeFromQueueTimeout() {
                                $this.removeNotify(notification);
            ...
            this.$get = ['$timeout', '$templateCache', function ($timeout, $templateCache) {
                ...
                return {
                    ...
                    controller: ['$scope', function NotificationsCtrl($scope) {
                            ...
                            $scope.removeNotification = function (noti) {
                                $notification.removeNotify(noti);
                            };
                        }
                    ]
